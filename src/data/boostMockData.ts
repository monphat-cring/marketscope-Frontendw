...
export const boostMockData: BoostData = {
  stocks: [
    { symbol: "TIINDIA",    sector: "AUTO",              ltp: 2849, change_pct:  3.47, fo: true,  boost_score: 4.2, vol_surge: 3.2, range_ratio: 2.1, near_20d_high: true,  near_20d_low: false, vwap_pct:  1.2 },
    { symbol: "MUTHOOTFIN", sector: "BANKING & FINANCE", ltp: 1840, change_pct:  3.50, fo: true,  boost_score: 3.9, vol_surge: 3.1, range_ratio: 1.9, near_20d_high: true,  near_20d_low: false, vwap_pct:  0.8 },
    ...
    { symbol: "PERSISTENT", sector: "IT",                ltp: 5200, change_pct: -1.10, fo: true,  boost_score: 2.9, vol_surge: 2.5, range_ratio: 1.4, near_20d_high: false, near_20d_low: false, vwap_pct: -0.7 },
    ...
    { symbol: "ITC",        sector: "FMCG",              ltp:  450, change_pct:  0.30, fo: true,  boost_score: 1.5, vol_surge: 1.2, range_ratio: 0.8, near_20d_high: false, near_20d_low: false, vwap_pct:  0.0 },
